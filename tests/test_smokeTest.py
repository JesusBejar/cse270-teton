...
class TestSmokeTest():
  ...
  def test_jOIN(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("hello")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("hello")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("hello")
  ...
  def test_dIRECTORY(self):
    ...
    self.driver.set_window_size(795, 699)
